...
export const EXERCISES = [
    ...
    // Cardio
    { id: 'running', name: 'Running', muscle: 'Cardio', type: 'cardio' },
    { id: 'cycling', name: 'Cycling', muscle: 'Cardio', type: 'cardio' },
    { id: 'rowing', name: 'Rowing', muscle: 'Cardio', type: 'cardio' },
    { id: 'jump_rope', name: 'Jump Rope', muscle: 'Cardio', type: 'cardio' },
    // Warmups
    { id: 'w_arm_circles', name: 'Arm Circles', muscle: 'Shoulders', type: 'Stretch' },
    { id: 'w_wall_slides', name: 'Wall Slides', muscle: 'Shoulders', type: 'Stretch' },
    { id: 'w_leg_swings', name: 'Leg Swings', muscle: 'Legs', type: 'Stretch' },
    { id: 'w_deep_squat', name: 'Deep Squat Hold', muscle: 'Legs', type: 'Stretch' },
    { id: 'w_cat_cow', name: 'Cat-Cow', muscle: 'Back', type: 'Stretch' },
    { id: 'w_thoracic', name: 'Thoracic Rotation', muscle: 'Back', type: 'Stretch' },
    { id: 'general_cardio', name: 'General Cardio', muscle: 'Full Body', type: 'Cardio' }
];
...
export const WORKOUT_TEMPLATES = [
    {
        ...
        name: 'Push Power',
        exercises: [
            { id: 'bench_press', sets: 4, targetReps: '5-8' },
            { id: 'overhead_press', sets: 3, targetReps: '8-10' },
            { id: 'lateral_raises', sets: 4, targetReps: '12-15' },
            { id: 'overhead_triceps_extension', sets: 3, targetReps: '10-12' }
        ]
    },
    {
        id: 't2',
        ...
        exercises: [
            { id: 'deadlift', sets: 3, targetReps: '5' },
            { id: 'pull_ups', sets: 4, targetReps: '10' },
            { id: 'dumbbell_row', sets: 3, targetReps: '10-12' },
            { id: 'bicep_curls', sets: 4, targetReps: '12-15' }
        ]
    }
];

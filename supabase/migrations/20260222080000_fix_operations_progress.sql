-- Fix: Update check_operations_progress to correctly calculate all metrics
...
BEGIN
  ...
  LOOP
      ...
      ELSIF v_ops.target_metric = 'duration' THEN
          v_progress_added := COALESCE(v_workout.duration, 0) / 60; -- converting seconds to minutes

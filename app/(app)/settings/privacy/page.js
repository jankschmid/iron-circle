...
export default function PrivacySettingsPage() {
    ...
    return (
        <div className="container" style={{ minHeight: '100vh', padding: '20px', paddingBottom: '100px' }}>
            <HardwareBackButton />
            {/* Header */}
            <header style={{
                display: 'flex',
                ...
                <button onClick={() => router.back()} style={{
                    background: 'none', border: 'none', color: 'var(--foreground)', fontSize: '1.5rem', cursor: 'pointer', padding: '8px', marginLeft: '-8px'
                }}>
                    ←
                </button>
                <h1 style={{ fontSize: '1.5rem', fontWeight: '800' }}>Privacy & Data</h1>
            </header>

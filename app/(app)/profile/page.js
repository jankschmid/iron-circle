...
export default function ProfilePage() {
    ...
    return (
        <div className="container" style={{ paddingBottom: '100px' }}>
            ...
            {/* TABS INITIALIZATION */}
            <div style={{ display: 'flex', borderBottom: '1px solid var(--border)', marginBottom: '24px', marginTop: '32px' }}>
                <button
            ...
            <section>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    ...
                    {/* --- In-App Upgrades & Feedback CTAs (Relocated) --- */}
                    <div style={{ marginTop: '12px', display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                        ...
                        <Link href="/upgrade" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', background: 'linear-gradient(135deg, rgba(250,255,0,0.08) 0%, rgba(200,200,0,0.02) 100%)', borderRadius: '16px', border: '1px solid rgba(250,255,0,0.3)', textDecoration: 'none', color: 'var(--foreground)', boxShadow: '0 4px 20px rgba(250,255,0,0.05)' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(250,255,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <img src="/assets/logo/Iron-Circle_Logo_Two_Color.svg" alt="Pro" style={{ width: '20px', height: '20px' }} />
                                </div>
                                <div>
                        ...
                        <Link href="/" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', background: 'var(--surface)', borderRadius: '16px', border: '1px solid var(--border)', textDecoration: 'none', color: 'var(--foreground)', transition: 'all 0.2s', marginTop: '12px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem' }}>🌍</div>
                                <div>
                                    <div style={{ fontWeight: '800', fontSize: '0.95rem' }}>{t('IronCircle Website')}</div>
                                    <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>{t('Go to the Landing Page')}</div>
                                </div>
                            </div>
                            <span style={{ color: 'var(--text-muted)', fontWeight: 'bold' }}>→</span>
                        </Link>
